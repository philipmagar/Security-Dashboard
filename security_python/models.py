...
class DetectionAlert:
    """
    Standardized detection alert generated by rule-based detection engine with dynamic risk scoring.
    """
    rule_id: str
    attack_type: str
    severity: str
    ...
    def source_ip(self) -> str:
        """Convenience property for source IP."""
        return self.source

    @property
    def details(self) -> Dict[str, Any]:
        """Consolidates evidence, rule metadata, risk score, and recommended response for DB storage."""
        return {
    ...
    def get(self, key: str, default: Any = None) -> Any:
        aliases = {
            ...
            "evidence": self.evidence,
            "recommended_response": self.recommended_response,
            "response": self.recommended_response,
            "details": self.details,
            "timestamp": self.timestamp,
        }
        return aliases.get(key, default)
    ...
    def __getitem__(self, key: str) -> Any:
        val = self.get(key)
        if val is None and key not in ("evidence", "details", "recommended_response"):
